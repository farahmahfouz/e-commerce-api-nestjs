import { IsEmail, IsEnum, IsNotEmpty, IsNumber, IsOptional, IsPhoneNumber, IsString, IsUrl, Length, MaxLength, MinLength } from "class-validator";
...
export class CreateUserDto {
    ...
    @IsOptional()
    @IsEnum([true, false], { message: 'isActive must be a boolean value' })
    isActive?: boolean;
